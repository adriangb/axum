...
- **added:** `serve::MaxConnectionAge` and `Serve::max_connection_age` for bounding the lifetime of
  individual connections (with `jitter` and `grace`), forcing clients to rotate
  connections ([#3779])
